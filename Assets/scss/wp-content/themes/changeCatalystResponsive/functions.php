...
if ( ! function_exists( 'changecatalystresponsive_setup' ) ) :
	...
	function changecatalystresponsive_setup() {
		...
		add_theme_support( 'custom-background', apply_filters( 'changecatalystresponsive_custom_background_args', array(
 ...
 */
function changecatalystresponsive_content_width() {
	// This variable is intended to be overruled from themes.
	// Open WPCS issue: {@link https://github.com/WordPress-Coding-Standards/WordPress-Coding-Standards/issues/1043}.
	// phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedVariableFound
	$GLOBALS['content_width'] = apply_filters( 'changecatalystresponsive_content_width', 640 );
}
add_action( 'after_setup_theme', 'changecatalystresponsive_content_width', 0 );
 ...
 */
function changecatalystresponsive_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'changecatalystresponsive' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'changecatalystresponsive' ),
...
add_action( 'widgets_init', 'changecatalystresponsive_widgets_init' );
